...
values ('2000-01-01', '2000-10-01', NULL, NULL, (select id from customers where name='test'), 'PROCESSING', 1);
...
values('test', '1:100', 'test', 100, 100, 1, (select id from productlines where name='test'), 1);
